...
import (
	...
	"github.com/demo/test/docs"

	testmodule "github.com/demo/test/x/test"
	testmodulekeeper "github.com/demo/test/x/test/keeper"
	testmoduletypes "github.com/demo/test/x/test/types"
...
func New(
	...
	testModule := testmodule.NewAppModule(appCodec, app.TestKeeper)
